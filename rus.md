...
Мой друг [Адам Сонтег][4] (Adam Sontag) называет это
...
1. [моя презентация][15] с конференции Full Frontall (Брайтон, Великобритания, 2012);
2. [grunt][16] — инструмент, который поможет автоматизировать процесс тестирования;
3. книга [Test-Driven JavaScript Development][17] Кристиана Джохансона, создателя
